...
class MainActivity : AppCompatActivity() {
    ...
    private fun startGame(selectedOperation: Int) {
        option1Button.setBackgroundResource(R.drawable.roundbutton)
        option2Button.setBackgroundResource(R.drawable.roundbutton)
        option3Button.setBackgroundResource(R.drawable.roundbutton)
        option4Button.setBackgroundResource(R.drawable.roundbutton)
    ...
    fun onOptionSelected(view: View) {
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            view.setBackgroundResource(R.drawable.roundbutton)
